...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_RTLTMPRO : LocalizeTarget<RTLTMPro.RTLTextMeshPro>
    {
        static LocalizeTarget_RTLTMPRO() { AutoRegister(); }
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.BeforeSceneLoad)] static void AutoRegister() { LocalizationManager.RegisterTarget(new LocalizeTargetDesc_Type<RTLTMPro.RTLTextMeshPro, LocalizeTarget_RTLTMPRO>() { Name = "RTL TMPRO", Priority = 101 }); }
